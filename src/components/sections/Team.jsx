    ...
    <section id="team" className="py-12 lg:py-24 bg-slate-50 relative">
      <div className="max-w-7xl mx-auto px-4 lg:px-6">
        <div className="mb-8 lg:mb-20 text-center max-w-3xl mx-auto">
          ...
          <h2 className="text-2xl lg:text-5xl font-bold text-slate-900 mb-4 lg:mb-6">
        ...
        {/* 2-COLUMN MOBILE GRID WITH COMPACT CARDS */}
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-6 lg:gap-8">
          {t.team.list.map((leader, index) => (
            <motion.div
              ...
              className="group relative rounded-xl lg:rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 aspect-[3/4] md:h-[450px]"
            >
              ...
              <div className="absolute bottom-0 left-0 w-full p-3 lg:p-6 transform translate-y-0 lg:translate-y-4 lg:group-hover:translate-y-0 transition-transform duration-300">
                ...
                {/* NAME */}
                <h3 className="text-sm lg:text-2xl font-bold text-white mb-2 lg:mb-4 leading-tight">
                  {leader.name}
                </h3>
                ...
                {/* MOBILE CONNECT */}
                <a href={links[index]} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1 text-[10px] lg:text-xs font-bold text-white/80 hover:text-ujenzi-accent uppercase tracking-widest mt-1">
