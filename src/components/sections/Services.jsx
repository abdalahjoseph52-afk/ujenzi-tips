...
const Services = () => {
  ...
  // Fallback Icon helper (since Sanity doesn't store icons easily)
  const getIcon = (index) => {
    const icons = [HardHat, Megaphone, Youtube, Users, Star];
    const Icon = icons[index % icons.length]; // Cycles through icons
    ...
    <section id="services" className="py-12 lg:py-20 bg-white relative">
      <div className="max-w-7xl mx-auto px-5 lg:px-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-6">
          {/* MAP THROUGH SANITY DATA INSTEAD OF STATIC FILE */}
