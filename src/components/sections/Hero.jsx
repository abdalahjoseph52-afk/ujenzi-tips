...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-[85vh] flex items-center pt-24 pb-10 lg:pt-32 overflow-hidden bg-ujenzi-dark text-white">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-5 lg:px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 border border-white/10 rounded-full text-ujenzi-accent text-[10px] font-bold uppercase tracking-widest mb-6 backdrop-blur-sm">
            <span className="w-1.5 h-1.5 bg-ujenzi-accent rounded-full animate-pulse"></span>
            {t.hero.badge}
          </div>
          
          {/* COMPACT TYPOGRAPHY FOR MOBILE */}
          <h1 className="text-3xl sm:text-5xl lg:text-7xl font-bold leading-tight mb-4 lg:mb-6">
          ...
          <p className="text-sm sm:text-lg text-slate-300 mb-8 max-w-md mx-auto lg:mx-0 leading-relaxed">
            {t.hero.desc}
          </p>
          
          <div className="flex flex-col sm:flex-row gap-3 mb-10 justify-center lg:justify-start">
            <a href="#contact" className="w-full sm:w-auto">
              <Button variant="primary" icon={ArrowRight} className="w-full justify-center text-sm py-3">{t.hero.cta1}</Button>
            </a>
            <a href="/calculator" className="w-full sm:w-auto">
              <Button variant="outline" icon={Play} className="w-full justify-center text-sm py-3">{t.hero.cta2}</Button>
            </a>
          </div>

          <div className="border-t border-white/10 pt-6">
            <p className="text-[10px] font-bold uppercase text-slate-500 tracking-widest mb-4">{t.hero.trusted}</p>
            <div className="flex flex-wrap justify-center lg:justify-start items-center gap-6 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
        ...
        <div className="hidden lg:block relative h-[550px]">
           ...
           <div className="absolute top-0 right-8 w-full h-full border-2 border-white/10 rounded-2xl"></div>
           <img 
           ...
           <motion.div 
             ...
             className="absolute bottom-8 -left-8 bg-white p-5 rounded-xl shadow-xl max-w-xs"
           >
